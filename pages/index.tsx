          ...
          <div className="row d-flex flex-column">
            ...
            <div className="text-block">
              <p>
                ...
                nationale de France, s’inscrit dans la continuité des initiatives menées autour de
                la collection des archives de l’internet de la BnF dans le cadre du projet ResPaDon.
              </p>
              <p>
                ...
                pour répondre à des questions de recherche portant sur une thématique disponible à
                la fois sur le web vivant et dans le périmètre des archives de l’internet. En
                équipant les archives de la BNF du crawler Hyphe développé par le médialab pour
                construire des corpus numériques, le DataSprint a donné l’opportunité à quatre
                équipes pluridisciplinaires, associant chercheurs et professionnels de l’information
                scientifique et technique, de tester de nouvelles pratiques et d’explorer de
                nouvelles pistes méthodologiques.
              </p>
            </div>
              ...
              <ul className="list-unstyled">
                <li className="mb-4">
                  ...
                  <div className="small">
                    ...
                    (BnF, Huma-Num), Cristina Tosetto (Université Sorbonne Nouvelle), Clara
                    Wiatrowski (BnF).
                  </div>
                </li>
                ...
                <li className="mb-4">
                  <div className="fw-bold">
                    <span className="yellow-dot" /> Crise de la COVID-19 : positionnement des
                    acteurs du web par rapport aux institutions
                  </div>
                  <div className="fst-italic">
                    L’idée principale est de réaliser une cartographie des discours qui permet
                    d’explorer le positionnement entre les acteurs du web et les sites
                    institutionnels qui traitent de la crise de la covid-19 entre décembre 2019 et
                    avril 2022.
                  </div>
                  <div className="small">
                ...
                <li className="mb-4">
                  ...
                  <div className="fst-italic">
                    ...
                    soutien aux candidats à l’élection présidentielle, à travers l’exemple
                    particulier des communautés de soutien à Jean-Luc Mélenchon, en analysant
                    notamment les partis plateformes en 2012, 2017 et 2022 ainsi que l’évolution des
                    formes éditoriales que prennent ces sites dans le temps.
                  </div>
                  <div className="small">
