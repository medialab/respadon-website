    ...
    <div className="container">
      ...
      <div className="row">
        ...
        <p>
          ...
          est le médialab. Sciences Po s&apos;engage à faire ses meilleurs efforts pour fournir une
          continuité de disponibilité du site web aux utilisateurs. Toutefois, Sciences Po ne pourra
          en aucun cas être tenu responsable de toute interruption de services intervenant sur le
          site web.
        </p>
      </div>
      ...
      <div className="row">
        ...
        <p>
          ...
          fournies sans garantie d&apos;aucune sorte. Elles sont non contractuelles, peuvent
          contenir des inexactitudes techniques ou typogra- phiques et sont sujettes à modification
          sans préavis.
        </p>
        <p>
        ...
        <p>
          ...
          ne peut être tenu responsable des dommages quelconques, directs ou indirects, matériels ou
          immatériels résultant notamment de la consultation et/ou de l&apos;utilisation du site web
          (ou d&apos;autres sites qui lui sont liés) et des éventuelles applications en
          téléchargement, comme de l&apos;utilisation des informations textuelles ou visuelles, qui
          auraient pu être recueillies et notamment de tout préjudice financier ou commercial, de
          pertes de programmes ou de données dans son système d&apos;information.
        </p>
        <p>
      ...
      <div className="row">
        ...
        <p>
          ...
          sommes responsables ni de leur intégral respect aux normes d&apos;ordre public et bonnes
          mœurs, d&apos;une part, ni de leur politique de protection des données personnelles ou
          d&apos;utilisation qui en seraient faites, d&apos;autre part. En accédant à un autre site,
          par l&apos;intermédiaire d&apos;un lien hypertexte, vous acceptez que cet accès
          s&apos;effectue à vos risques et périls. En conséquence, tout préjudice direct ou indirect
          résultant de votre accès à un autre site relié par un lien hypertexte ne peut engager la
          responsabilité de Sciences Po.
        </p>
      </div>
      ...
      <div className="row">
        ...
        <p>
          ...
          données 2016/679 (dit &quot;RGPD&quot;), les données personnelles traitées sur le site web
          sont, selon les finalités de traitement, nécessaires à l&apos;exécution de la mission de
          service public de Sciences Po.
        </p>
        <p>
          Ce site ne collecte aucune information personnelle, à l&apos;exception des données brutes
          anonymisées de visites et d&apos;actions collectées par Matomo, un traceur d&apos;audience
          hébergé à Sciences Po pour la production de statistiques de consultation du site web.
          Cette collecte se fait sans utiliser de cookies et respecte les paramètres de votre
          navigateur en matière de confidentialité. Les données brutes anonymisées de visites sont
          uniquement consultées par le médialab à des fins d&apos;amélioration de l&apos;expérience
          utilisateur.
        </p>
        <p>
        ...
        <p>
          ...
          dataprotection [AT]sciencespo.fr. Vous pouvez exercer vos droits d&apos;accès, de
