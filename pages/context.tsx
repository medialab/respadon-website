  ...
  <Layout page="context">
    ...
    <div className="container">
      ...
      <p>
        ...
        développer et à diversifier les usages par les chercheurs des archives du web collectées et
        conservées par la Bibliothèque nationale de France (BnF). Soutenu par le GIS CollEx-Persée,
        le projet ResPaDon est porté par l’Université de Lille et la Bibliothèque nationale de
        France, en partenariat avec Sciences Po Paris et le Campus Condorcet. Il mobilise les
        équipes de recherche du médialab de Sciences Po et le laboratoire GERiiCO.
      </p>
      <p>
        Constitué autour d’un premier noyau d’établissements de l’Enseignement supérieur et de la
        Recherche, il s’appuie sur les initiatives prises par ces établissements en matière de
        services à la recherche pour favoriser le développement d’expérimentations.
      </p>
      <p>
        En procédant de manière itérative avec les équipes de recherche et les personnels d’appui à
        la recherche des bibliothèques, le projet ResPaDon doit contribuer à faire émerger une
        dynamique inter-établissement, où les collections numériques et les services aux chercheurs
        proposés par la BnF viennent enrichir l’offre des établissements documentaires de l’ESR en
        direction de leurs communautés scientifiques.
      </p>
      <p>
        ...
        Commun de la Documentation de l’Université de Lille et la BnF, sont répartis entre plusieurs
        groupes de travail auxquels participent Sciences Po et le Campus Condorcet.
      </p>
      <p>
      ...
      <p>
        ...
        groupe de travail qui réunit des personnels de Sciences Po et de la BnF propose, dans une
        approche expérimentale, d’utiliser les outils développés par le médialab, un des
        laboratoires de recherche de Sciences Po, pour répondre à des questions de recherche portant
        sur des sources disponibles à la fois sur le web vivant et dans le périmètre des archives de
      ...
      <h3 className="h4">Qu’attendre d’un datasprint ?</h3>
      ...
      <p>
        ...
        faut apprendre à travailler à plusieurs dans un temps très court. La clé de la réussite se
        trouve dans l’écoute et le partage de compétences différentes qui permettent d’aborder les
        problèmes sous plusieurs angles à la fois.
      </p>
      ...
      <p>
        Le cadre particulier du datasprint permet, par la discussion collective, de sélectionner les
        pistes interprétatives qui font sens ensemble et de les organiser en une narration lisible
        hors des frontières du groupe. Les projets des datasprints tendent à donner lieu à de
        nouvelles formes de récits d’expérimentation, qui racontent autant le résultat (la
      ...
      <p>
        Des outils, des images, des données… La nécessité d’être passeur de sens dans un temps très
        court encourage la mobilisation d’autres moyens que l’écriture d’un texte. Dans un
        datasprint, la question de la transmission du savoir se pose d’une façon plus brutale, plus
        proche de la vie de laboratoire que d’une communication dans un colloque. En ce sens, un
        datasprint est une expérimentation et le compte rendu d’expérimentation sera le témoin de
        cette activité. Comment redramatiser un réseau ? Comment ramener la vie dans des données
        qu’on considère à tort comme froides ? Comment attaquer des jeux de données parcellaires ?
        L’interdisciplinarité au cœur de l’organisation du datasprint, la présence de designers et
        d’autres compétences, permet de débloquer de nouvelles pratiques de connaissance et
        d’initier des réflexions méthodologiques fécondes et innovantes.
      </p>
      <br />
      <h3 className="h4">Méthode de travail</h3>
      <p>
        Les participants se répartissent en petits groupes de travail, selon leurs affinités mais
        aussi leurs compétences. Dans l’idéal, chaque groupe met en jeu les rôles suivants : un
        porteur qui apporte les questions de recherche, un facilitateur qui aide au dialogue entre
        les participants, un expert capable d’interpréter les données, un ingénieur ayant les
        compétences techniques nécessaires au traitement des données, un documentaliste qui veille à
        rendre compte des processus mis en oeuvre dans l’expérimentation et un designer pour
        produire des visualisations. Un participant peut avoir plusieurs rôles.
      </p>
      <p>
        À la fin de chaque journée de travail, les groupes font une brève présentation de l’avancée
        de leurs travaux et s’assurent que les différents aspects de leur travail sont bien
        documentés.
      </p>
      <p>
      ...
      <p>
        La diversité des compétences des participants implique de remettre à plat la répartition des
        tâches. Ainsi, chacun pourra être amené à suggérer des pistes de recherche, manipuler les
        données, et se pencher sur l’analyse et la mise en forme des résultats.
      </p>
      ...
      <p>
        ...
        méthodologiques sont proposés aux participants. Les personnes jouant le rôle de
        facilitateurs font le lien entre les différents groupes et invitent à la discussion.
        L’utilisation des espaces d’affichage du lieu permet d’afficher les productions en cours et
        ainsi les rendre visibles aux autres équipes sans interruptions inopportunes.
      </p>
      <h4 className="h5">3. Mutualiser entre les équipes durant l’événement</h4>
      <p>
        Les séances de travail du datasprint provoquent parfois un “effet bulle” dans lequel chaque
        équipe peut rapidement se déconnecter du travail effectué par les autres, entraînant parfois
      ...
      <p>
        L’un des intérêts du format datasprint est de favoriser une unité de temps et de lieu pour
        le travail interdisciplinaire. Cette intensité appelle cependant une valorisation à la
      ...
      <p>
        Depuis le 1er août 2006, la Bibliothèque nationale de France (BnF) et l’Institut national de
        l’audiovisuel (INA) ont pour mission d’archiver les sites internet français dans le cadre de
        leur mission de dépôt légal, une mission inscrite dans le{' '}
        <a href="https://www.legifrance.gouv.fr/codes/section_lc/LEGITEXT000006074236/LEGISCTA000006144103/#LEGISCTA000006144103">
          Code du patrimoine
        </a>
        . Au titre de cette mission, la BnF et l’INA collectent des sites web français afin de les
        conserver et de les communiquer à des fins de recherche.
      </p>
      <p>
        La BnF est responsable de la collecte des sites web du domaine français dont le périmètre
        comprend les sites enregistrés en .fr et dans les extensions régionales (.re, .nc, .bzh,
        etc.) , les sites dont les contenus sont produits en France et les sites dont les
        producteurs sont domiciliés en France. L’INA est plus spécifiquement responsable des sites
        web des chaînes françaises de télévision et de radio.
      </p>
      <p>
      ...
      <p>
        ...
        reposent depuis 2004 sur l’utilisation de robots logiciels, qui copient les pages web et
        leurs éléments constitutifs, ainsi que sur deux types de collecte :
      </p>
      <ul>
        <li>
          Collecte large : Effectuée une fois par an avec l’objectif de réaliser un échantillon de
          plusieurs millions de sites web en s’appuyant sur des listes établies par des partenaires
          comme l’Afnic et OVH.
        </li>
        <li>
          Collectes ciblées (courantes ou d’urgence) : Effectuées en fonction des besoins en
          s’appuyant sur les listes établies par des bibliothécaires de la BnF et des bibliothèques
          partenaires en région ainsi que par des chercheurs ou des spécialistes d’un sujet. Ces
          collectes permettent de constituer des archives plus complètes et plus fréquentes de
          dizaines de milliers de sites web. Ces sites sont choisis en raison de leur thème (la
          littérature, le développement durable...) ou de leur rapport à un événement (les
          élections, les Jeux olympiques, l’épidémie de Covid-19…). Les listes des sites
          sélectionnés pour ces collectes ciblées sont consultables librement en ligne sur le
      ...
      <p>
        En savoir plus sur les conditions d’accès, les collections et l’actualité sur les archives
        du web de la BnF :
      </p>
      <div>
